...
public class DevoteeDao {
    ...
    public static final class CounterStats {
        ...
        public CounterStats(long t, long m, long r, long d) { this.totalDevotees = t; this.totalMappedWhatsAppNumbers = m; this.registeredDevoteesInWhatsApp = r; this.devoteesWithAttendance = d; }
    ...
    private EnrichedDevotee enrichedFromCursor(Cursor cursor, EventStatus eventStatus) {
    ...
    public static String normalizePhone(String s) {
        ...
        for (String part : parts) {
            ...
            if (!digits.trim().isEmpty()) { return last10(digits); }
        }
        return null;
    }
