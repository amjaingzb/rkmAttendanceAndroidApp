...
public class Donation {
    ...
    public Donation(Long donationId, long devoteeId, Long eventId, double amount, String paymentMethod, String referenceId, String purpose, String donationTimestamp, String createdByUser) {
